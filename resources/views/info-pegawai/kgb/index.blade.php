...
@section('title', 'Info KGB Pegawai')
...
<main class="mt-[120px]">
    <div class="max-w-[1600px] mx-auto px-10">
        ...
        <div class="flex justify-between items-center mb-10 animate-fade-in-down">
            <div>
                <h2 class="text-3xl font-bold text-gray-800">Info Kenaikan Gaji Berkala Pegawai</h2>
                <p class="text-gray-500 mt-3 text-lg">Informasi lengkap KGB seluruh pegawai</p>
            </div>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="bg-gray-50 border-b border-gray-100">
                            ...
                            <th class="px-8 py-5 text-left text-base font-semibold text-gray-600">MKG KGB Terakhir</th>
                            <th class="px-8 py-5 text-left text-base font-semibold text-gray-600">TMT KGB</th>
                        ...
                        <tr class="hover:bg-blue-50 transition-colors duration-200">
                            ...
                            <td class="px-8 py-5">
                                <div class="text-base text-gray-600">
                                    {{ \Carbon\Carbon::parse($p['tmt_kgb'])->format('d/m/Y') }}
                                </div>
                            </td>
                            <td class="px-8 py-5">
                                <div class="text-base text-gray-600">
