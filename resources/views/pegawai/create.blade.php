...
<main class="mt-[100px]">
    ...
    <div class="p-6">
        <h2 class="text-xl font-semibold text-gray-800 mb-6">Tambah Data Pegawai</h2>
        ...
        NIP <span class="text-red-500">*</span>
                ...
                <div>
                    ...
                    <select name="kode_kelamin" 
                            class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-150" 
                            required>
                        <option value="">Pilih Jenis Kelamin</option>
                        <option value="L" {{ old('kode_kelamin') == 'L' ? 'selected' : '' }}>Laki-laki</option>
                        <option value="P" {{ old('kode_kelamin') == 'P' ? 'selected' : '' }}>Perempuan</option>
                    </select>
                    @error('kode_kelamin')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" name="jenjang_jabatan" value="{{ old('jenjang_jabatan') }}" 
                           class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-150" 
                           required>
                ...
                <div>
                    ...
                    <input type="text" name="status_pegawai" value="{{ old('status_pegawai') }}" 
                           class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-150" 
                           required>
                ...
                <div>
                    ...
                    <input type="text" name="grading" value="{{ old('grading') }}" 
                           class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-150">
                    @error('grading')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="date" name="tmt_grading" value="{{ old('tmt_grading') }}" 
                           class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-150">
                    @error('tmt_grading')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" name="kode_golongan_ruang" value="{{ old('kode_golongan_ruang') }}" 
                           class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-150" 
                           required>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">MKG Sesuai KGB Terakhir <span class="text-red-500">*</span></label>
                    <input type="text" name="mkg_kgb_terakhir" value="{{ old('mkg_kgb_terakhir') }}" 
                           class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-150" 
                           required>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">TMT Awal Penugasan di Lhokseumawe <span class="text-red-500">*</span></label>
                    <input type="date" name="tmt_awal_penugasan" value="{{ old('tmt_awal_penugasan') }}" 
                           class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-150" 
                           required>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">TMT Penempatan di Seksi Terakhir</label>
                    <input type="date" name="tmt_penempatan_seksi" value="{{ old('tmt_penempatan_seksi') }}" 
                           class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-150">
